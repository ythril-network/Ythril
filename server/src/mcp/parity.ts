...
export const REST_ONLY_CAPABILITIES: readonly RestOnlyCapability[] = [
  ...
  },
  {
    ...
    why: 'governing a network is partly on MCP: an agent can read, create, update and leave one, add a space to it, see and cast its votes and read its sync history (`network_get`, `network_create`, `network_update`, `network_leave`, `network_add_space`, `network_votes`, `network_vote`, `network_sync_history`), see peers and trigger a sync — and cannot yet join or fork one, invite, or manage its members.',
  },
  {
